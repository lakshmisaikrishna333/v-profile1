...
stage('nexus'){
        nexusArtifactUploader artifacts: [[artifactId: 'vprofile-v2', classifier: '', file: '/var/lib/jenkins/workspace/v-profile/target/vprofile-v2.war', type: 'war']], credentialsId: '56cd9671-d42c-4b94-afbd-96be55421899', groupId: 'com.visualpathit', nexusUrl: '54.175.126.120:8081', nexusVersion: 'nexus3', protocol: 'https', repository: 'http://54.175.126.120:8081/repository/vprofile-snapshot/', version: 'v2-SNAPSHOT'
}
}
